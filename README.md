...
![Google Scholar](https://img.shields.io/badge/Google%20Scholar-450%20citations-4285F4?style=for-the-badge&logo=googlescholar&logoColor=white)
![H-index](https://img.shields.io/badge/H--index-13-34A853?style=for-the-badge)
...
|:----:|:-----:|-------|:---------:|
| 2025 | PLoS ONE | [Res-VMamba: Fine-Grained Food Category Visual Classification Using Selective State Space Models with Deep Residual Learning](https://arxiv.org/abs/2402.15761) | 65 |
| 2024 | IEEE SiPS | [QEEGNet: Quantum Machine Learning for Enhanced Electroencephalography Encoding](https://ieeexplore.ieee.org/document/10768221) | 49 |
| 2024 | arXiv | [Mind's Eye: Image Recognition by EEG via Multimodal Similarity-Keeping Contrastive Learning](https://arxiv.org/abs/2406.16910) | 31 |
| 2026 | Quantum Sci. Technol. | [QASA: Quantum Adaptive Self-Attention for Quantum Transformer Models](https://arxiv.org/abs/2504.05336) | 27 |
| 2025 | IEEE CIBCB | [Enhancing Clinical Decision-Making: Integrating Multi-Agent Systems with Ethical AI Governance](https://arxiv.org/abs/2504.03699) | 26 |
| 2025 | arXiv | [Large Cognition Model: Towards Pretrained EEG Foundation Model](https://arxiv.org/abs/2502.17464) | 26 |
| 2023 | J. Affective Disorders | [Prediction of Antidepressant Responses to Non-Invasive Brain Stimulation Using Frontal EEG Signals](https://doi.org/10.1016/j.jad.2023.08.049) | 20 |
| 2023 | Ann. Biomed. Eng. | [Intraoperative Detection of Surgical Gauze Using Deep Convolutional Neural Network](https://doi.org/10.1007/s10439-022-03033-9) | 19 |
| 2025 | ICASSP | [Quantum Multimodal Contrastive Learning Framework](https://ieeexplore.ieee.org/document/10889504) | 18 |
| 2025 | IEEE QCE | [Quantum RL Trading Agent for Sector Rotation in the Taiwan Stock Market](https://ieeexplore.ieee.org/document/11250048) | 6 |

📊 Full list → [Google Scholar](https://scholar.google.com.tw/citations?user=5XHD7nkAAAAJ&hl=zh-TW) · *Citations recorded on 2026-08-30*
...
- [**Res-VMamba**](https://github.com/ChiShengChen/ResVMamba) ![Stars](https://img.shields.io/github/stars/ChiShengChen/ResVMamba?style=social)  
  Fine-grained food classification using state space models with deep residual learning. *PLoS ONE, 65 citations.*
...
- [**MUSE EEG**](https://github.com/ChiShengChen/MUSE_EEG) ![Stars](https://img.shields.io/github/stars/ChiShengChen/MUSE_EEG?style=social)  
  Mind's Eye: EEG-based image recognition using multimodal similarity-keeping contrastive learning. *31 citations.*
...
- [**QEEGNet**](https://github.com/ChiShengChen/QuantumEEGNet) ![Stars](https://img.shields.io/github/stars/ChiShengChen/QuantumEEGNet?style=social)  
  Hybrid quantum-classical encoder model for EEG representation learning. *IEEE SiPS 2024, 49 citations.*

- [**QASA**](https://github.com/ChiShengChen/QASA) ![Stars](https://img.shields.io/github/stars/ChiShengChen/QASA?style=social)  
  Quantum Adaptive Self-Attention for Quantum Transformer Models. *Quantum Sci. Technol. 2026, 27 citations.*

- [**QCL**](https://github.com/ChiShengChen/QCL) ![Stars](https://img.shields.io/github/stars/ChiShengChen/QCL?style=social)
  Quantum Multimodal Contrastive Learning for EEG-image analysis. *ICASSP 2025, 18 citations.*
...
- [**LCM — Large Cognition Model**](https://github.com/ChiShengChen/LCMv1) ![Stars](https://img.shields.io/github/stars/ChiShengChen/LCMv1?style=social)
  Self-supervised EEG foundation model using momentum contrastive learning and masked reconstruction for pretraining on cross-montage EEG data. *[arXiv](https://arxiv.org/abs/2502.17464), 26 citations.*
...
- [**Necomimi**](https://github.com/ChiShengChen/EEG_gen_img_NECOMIMI)  
  EEG-to-Image generation using diffusion models with neural cognitive alignment. *14 citations.*
...
- [NTQIP NEI-6 Prediction](https://github.com/ChiShengChen/NTQIP_nei-6_prediction_tree)  
  Decision-tree-based trauma outcome prediction on the TQIP NEI-6 dataset using demographics, GCS, vitals, and injury mechanism features.
- [TQIP NEI-6 Local Feature Analysis](https://github.com/ChiShengChen/tqip_nei6_local_feature)  
  Local feature engineering and analysis pipeline for TQIP NEI-6 trauma prediction.
- [Trauma Activation Matcher](https://github.com/ChiShengChen/trauma-activation-matcher)  
  Automated matching of trauma activation registry data with EMS audio recordings using time-window, demographics, and injury pattern matching.
...
- [QRL for Industry Sector Rotation](https://github.com/ChiShengChen/QuantumRL_TW_sector_rotation)  
  [QCE25](https://ieeexplore.ieee.org/document/11250048) Quantum Reinforcement Learning agent for industry sector rotation in the stock market.
...
- [Diffusion QASA](https://github.com/ChiShengChen/Diffusion_QASA)  
  Applying Quantum Adaptive Self-Attention (QASA) to diffusion models.
- [Quantum Attention](https://github.com/ChiShengChen/Quantum-Attention)  
...
- [Opensource EEG Dataset](https://github.com/ChiShengChen/Opensource_EEG_dataset)  
  Curated table of open-source EEG datasets with detailed specs (montage, sampling rate, subjects, classes) for ML and BCI research.

#### 🈵 Natural Language Processing, LLM Related
- [ctext.org Chinese Poem Crawler](https://github.com/ChiShengChen/ctext.org_-crawler)  
...
- [LLM Finetune Tutorial](https://github.com/ChiShengChen/LLM_Finetune_Tutorial)  
  Comprehensive examples and scripts for fine-tuning LLMs using DeepSpeed, NVIDIA NeMo, and Unsloth.
...
- [Solana PDA Practice](https://github.com/ChiShengChen/Solana_PDA_Practice)  
  A simple Solana program that manages user data accounts with messages that can be updated through PDA.
